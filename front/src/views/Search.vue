...
import SearchCity from "../components/search/SearchCity.vue"

const isSetPrefecture = ref(false);
...
const showConsole = (data) => {
  console.log(data);
  isSetPrefecture.value = true;
}
</script>

<template>
  <div class="layout-screen">  
    <div class="search-prefecture" v-if="!isSetPrefecture">
      <p>自治体を選択</p>
      <p>ごみの分別情報を知りたい都道府県を選択してください</p>
      <div id="jmap"></div>
    </div>
    <SearchCity v-if="isSetPrefecture"/>
  </div>
</template>
